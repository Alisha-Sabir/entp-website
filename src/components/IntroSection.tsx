    ...
    <div className="mt-5 mt-xl-3">
      <IntroComponent
        ...
        description="At Entterprice, we are committed to transparency, regulatory
              ...
              operations. Our governance framework ensures that every transaction is handled with integrity, backed by proactive risk-based approach and international best practices. We take pride
